...
import os
import pandas as pd
from ana_dependencies.get_bout_features import get_bout_timeseries
...
for pick_data in datasets:
    ...
    all_around_peak_data, all_cond0, all_cond1, idxRANGE = get_bout_timeseries(root, FRAME_RATE, ztime=which_ztime,day_light_narrow_bin=True)

    # Out put in .csv
    output_file = os.path.join(out_dir, f'{pick_data}_{which_ztime}_timeSeries.csv')
